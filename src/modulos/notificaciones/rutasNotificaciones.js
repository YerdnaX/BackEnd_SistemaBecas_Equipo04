...
import { listarNotificaciones, marcarNotificacionLeida, marcarTodasLeidas } from '../../servicios-compartidos/servicioNotificaciones.js';
...
rutas.patch('/leer-todas', asincrono(async (req, res) => {
  await marcarTodasLeidas(req.usuario.idUsuario);
  enviarExito(res, { mensaje: 'Todas las notificaciones fueron marcadas como leidas.' });
}));
